use devvani_lexer::{TokenKind, Span};
...
pub enum ParseError {
    ...
    DuplicateDefinition { name: String, first_at: Span, second_at: Span },
    
    #[error("ParseError: Karaka conflict for role {role:?}")]
    KarakaConflict { role: KarakaRole, first: Span, second: Span },
    ...
    InvalidLakara { found: Lakara, context: String, span: Span },
