...
pub enum StdlibError {
    ...
    ArgCount { dhatu: String, expected: usize, got: usize },
    
    #[error("Wrong type for {dhatu}: expected {expected}, got {got}")]
    TypeError { dhatu: String, expected: String, got: String },
...
mod tests {
    ...
    fn test_ganavati_len() {
        let reg = DhatuRegistry::new();
        let result = reg.call("ganavati", vec![
            DvnValue::Suchi(vec![
                DvnValue::Sankhya(1),
                DvnValue::Sankhya(2),
                DvnValue::Sankhya(3),
    ...
    fn test_parinameti_int_conversion() {
        let reg = DhatuRegistry::new();
        let result = reg.call("parinameti", vec![
            DvnValue::Vakya("42".to_string())
        ]).unwrap();
    ...
    fn test_yojayati_sum() {
        let reg = DhatuRegistry::new();
        let result = reg.call("yojayati", vec![
            DvnValue::Suchi(vec![
                DvnValue::Sankhya(10),
                DvnValue::Sankhya(20),
                DvnValue::Sankhya(30),
    ...
    fn test_kramate_range() {
        let reg = DhatuRegistry::new();
        let result = reg.call("kramate", vec![
            DvnValue::Sankhya(0),
            DvnValue::Sankhya(3),
            DvnValue::Sankhya(1),
        ]).unwrap();
        assert_eq!(result, DvnValue::Suchi(vec![
            DvnValue::Sankhya(0),
            DvnValue::Sankhya(1),
            DvnValue::Sankhya(2),
        ]));
    ...
    fn test_janayati_type() {
        let reg = DhatuRegistry::new();
        let result = reg.call("janayati", vec![
            DvnValue::Vakya("hello".to_string()),
        ]).unwrap();
    ...
    fn test_tulayati_abs() {
        let reg = DhatuRegistry::new();
        let result = reg.call("tulayati", vec![
            DvnValue::Sankhya(-99),
        ]).unwrap();
    ...
    fn test_dvibhajati_bin() {
        let reg = DhatuRegistry::new();
        let result = reg.call("dvibhajati", vec![
            DvnValue::Sankhya(10),
        ]).unwrap();
    ...
    fn test_sarvayati_all() {
        let reg = DhatuRegistry::new();
        let result = reg.call("sarvayati", vec![
            DvnValue::Suchi(vec![
                DvnValue::Satya(true),
                DvnValue::Satya(true),
                DvnValue::Satya(true),
    ...
    fn test_samyojayati_join() {
        let reg = DhatuRegistry::new();
        let result = reg.call("samyojayati", vec![
    ...
    fn test_vibhajati_split() {
        let reg = DhatuRegistry::new();
        let result = reg.call("vibhajati", vec![
    ...
    fn test_anukramati_slice() {
        let reg = DhatuRegistry::new();
        let result = reg.call("anukramati", vec![
            DvnValue::Suchi(vec![
                DvnValue::Sankhya(0),
                DvnValue::Sankhya(1),
                DvnValue::Sankhya(2),
